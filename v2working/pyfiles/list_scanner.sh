...
echo "${bold}\e[91m[!] WARNING: \e[4mBEFORE YOU PROCEED KEEP IT IN MIND THAT IT WILL TAKE A WHILE TO FINISH THE SCAN, IF YOU STOP THE TESTING IN THE MIDDLE THEN OUTPUT WILL NOT BE GENERATED AS PROCESS WILL BE INCOMPLETE...\e[0m \e[91m${normal}"
echo "[*] Press Any Key To Continue... \n[*] Press 'Ctrl+C' or 'Ctrl+Z' To Stop This Process..."
read -p "" l
clear
...
sleep 1
while read ip; do
#echo "\e[101m \n[+] Testing IP : $ip \e[0m" && nmap -v -sV -d -A -p1-65535 --script discovery,vuln,malware,default -T4 -Pn $ip -oA $ip
